...
public class DynaClassLoaderTest extends DynaTest {
  ...
  public void testDynaClassLoader() throws Exception {
    ...
    final Class<ByteCode> byteCodeClass = (Class<ByteCode>) classLoader.loadClass("io.vlingo.common.compiler.ByteCode");
    ...
    final Class<DynaFile> actorDynaClass = (Class<DynaFile>) classLoader.loadClass("io.vlingo.common.compiler.DynaFile");
